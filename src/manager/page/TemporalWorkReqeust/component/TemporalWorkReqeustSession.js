...
function TemporalWorkReqeustSession() {
  ...
  const getAbsenceData = async () => {
    await axios
      .get("http://localhost:8080/absence")
      .then((res) => {
  ...
  function temporalList() {
    return temporalData.map((data, id) => (
  ...
  return (
    ...
    <div className="TemporalWorkReqeustSession">
      <div className="TemporalWorkReqeustMain">
        <div className="TemporalMain">
          <div className="TemporalBox">
            <div className="temporallist-name">임시 근로</div>
          ...
          <div className="TemporalBox">
            <div className="temporallist-name">결근</div>
            <div className="temporalList">{absenceList()}</div>
            <div className="temporal_button">
              <button
                className="temporal_btn"
                onClick={() => temApprovalClicked()}
