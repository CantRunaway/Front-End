      ...
      <div className='menu'>
        <ul>
          ...
          <ul className='menu_title' onClick={() => {setView1(!view1)}}>
            🏃‍♂️근무자 관리 {" "}
            {view1 ? <img className="plus-minus" src="/img/sideplus.png" />
             : 
             <img className="plus-minus" src="/img/sideminus.png" />}
          ...
          <ul className='menu_title' onClick={() => {setView2(!view2)}}>
            🏃‍♂️임시 근로 관리
            {view2 ? <img className="plus-minus" src="/img/sideplus.png" />
             : 
             <img className="plus-minus" src="/img/sideminus.png" />}
          ...
          <ul className='menu_title' onClick={() => {setView3(!view3)}}>
            🏃‍♂️근로 관리{" "}
            {view3 ? <img className="plus-minus" src="/img/sideplus.png" />
             : 
             <img className="plus-minus" src="/img/sideminus.png" />}
            {view3 && 
            <>
