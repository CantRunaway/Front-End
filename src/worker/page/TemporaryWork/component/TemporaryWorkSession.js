...
function TemporaryWorkSession(){
    ...
    const addTemporaryRequist = async() => {
        if((plusAbsence.absence_start[3] === '3' || plusAbsence.absence_start[3] === '0') && plusAbsence.absence_start[4] === '0'){
            if(plusAbsence.absence_start < plusAbsence.absence_end){
